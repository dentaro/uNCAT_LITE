...
#define LCD_WIDTH 240                  // LCD real width
#define LCD_HEIGHT 240                 // LCD real height
  ...
  {
    {
      ...
      cfg.spi_host = HSPI_HOST; //SPI2_HOST; 
      cfg.spi_mode = 0;//SPI_MODE;          
      cfg.freq_write = 64000000;//80000000;
      cfg.freq_read = 16000000;  
      cfg.spi_3wire = true;      
      cfg.use_lock = true;        
      cfg.dma_channel = 0;//SPI_DMA_CH_AUTO; 
